#ifndef CHESS_PIECES_KNIGHT_HPP
#define CHESS_PIECES_KNIGHT_HPP

#include "../core/Piece.hpp"

namespace chess::pieces {

class Knight : public chess::core::Piece {
public:
    Knight(chess::core::Color color, const chess::core::Position& position);
